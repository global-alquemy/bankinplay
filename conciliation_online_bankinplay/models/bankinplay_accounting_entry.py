...
# odoo16: tipos de cuenta de cliente/proveedor (antes internal_type)
...
class BankinplayAccountingEntry(models.Model):
    ...
    def _is_tercero_type(self):
        ...
        for line in self.line_ids:
            ...
            if account and account.account_type in RECEIVABLE_PAYABLE:
                return True
        return False
        ...
        * **Cuenta distinta a la del diario** (histórico de línea de crédito): se
        ...
        for line in lines_to_post:
            ...
            new_aml.append({
                ...
                # odoo16: analítica por distribución (no analytic_account_id)
